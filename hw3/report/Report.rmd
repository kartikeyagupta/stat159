...
```{r eval=TRUE, echo=FALSE, results='asis', message=FALSE}
print(xtable(lm(Sales~TV, simple),caption = "Regression of Sales on TV"), comment = FALSE)

print(xtable(lm(Sales~Radio, simple),caption = "Regression of Sales on Radio"), comment = FALSE)

print(xtable(lm(Sales~Newspaper, simple),caption = "Regression of Sales on Newspaper"), comment = FALSE)
```
